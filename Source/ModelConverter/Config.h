...
enum Config
{
    ...
    CONFIG_FORCES                               = CONFIG_FLAG_V2_SAMPLE_CHUNK | CONFIG_FLAG_NO_NODE_LIMIT | CONFIG_FLAG_D3D11_VERTEX_FORMAT,
    CONFIG_FRONTIERS                            = CONFIG_FLAG_V2_SAMPLE_CHUNK | CONFIG_FLAG_NO_NODE_LIMIT | CONFIG_FLAG_D3D11_VERTEX_FORMAT | CONFIG_FLAG_TRIANGLE_LIST
};