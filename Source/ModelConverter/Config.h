...
enum Config
{
    ...
    CONFIG_FLAG_D3D11_VERTEX_FORMAT             = 1 << 3,
    CONFIG_FLAG_TRIANGLELIST_PRIMITIVE_TOPOLOGY = 1 << 4,
    ...
    CONFIG_FRONTIERS                            = CONFIG_FLAG_V2_SAMPLE_CHUNK | CONFIG_FLAG_D3D11_VERTEX_FORMAT | CONFIG_FLAG_TRIANGLELIST_PRIMITIVE_TOPOLOGY
};